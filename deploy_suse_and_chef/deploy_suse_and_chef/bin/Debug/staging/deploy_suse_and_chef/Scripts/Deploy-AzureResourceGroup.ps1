...
Param(
    ...
    [string] $ResourceGroupName = 'deploy_chef_win_env',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageAccountResourceGroupName, 
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = '..\Templates\deploy_suse_and_chef.json',
    [string] $TemplateParametersFile = '..\Templates\deploy_suse_and_chef.parameters.json',
